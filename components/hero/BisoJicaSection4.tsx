...
const features = [
  {
    icon: "🦠",
    title: "Rửa sạch nấm bệnh",
    desc: "Rửa sạch nấm bệnh, trị rệp sáp, nhện đỏ, bọ trĩ, ruồi vàng",
  },
  {
    icon: "🍊",
    title: "Trái bóng đẹp",
    desc: "Giữ trái không thối, trái đẹp, bóng, ngọt và lâu hư",
  },
  {
    icon: "📦",
    title: "Bảo quản lâu",
    desc: "Bảo quản trái lâu hơn, giảm hư hao, an toàn cho người dùng",
  },
  {
    icon: "🍃",
    title: "Bổ sung dinh dưỡng",
    desc: "Bổ sung chất dinh dưỡng, giúp cây khỏe, lá xanh",
  },
];

export default function BisoJicaSection4() {
