...
const features = [
  {
    icon: "🦠",
    title: "Trị tuyến trùng & nấm bệnh",
    desc: "Trị tuyến trùng, nấm bệnh, thối rễ, giải độc đất, phục hồi đất bạc màu",
  },
  {
    icon: "🌱",
    title: "Kích hoạt vi sinh có lợi",
    desc: "Kích hoạt vi sinh vật có lợi, tăng sức đề kháng, giúp cây xanh khỏe",
  },
  {
    icon: "🍃",
    title: "Phục hồi cây suy",
    desc: "Khắc phục vàng lá, cây suy, kéo đọt nhanh, phát triển bộ rễ",
  },
  {
    icon: "⏱️",
    title: "Hiệu quả nhanh",
    desc: "Hiệu quả rõ rệt sau 3 lần tưới / 30 ngày, duy trì tưới định kỳ hàng tháng",
  },
];

export default function BisoJicaSection3() {
      ...
      >
        ...
        <div style={{ paddingRight: mobile ? 0 : 20 }}>
          ...
          >
            ...
            >
              "Tiết kiệm 70% phân bón - 
              vẫn trúng mùa bội thu"
            </p>
          </blockquote>
        </div>
