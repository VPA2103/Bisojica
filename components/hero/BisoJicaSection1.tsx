...
const features = [
  {
    icon: "🌿",
    title: "Trị côn trùng gây hại",
    desc: "Trị và ngăn nhện đỏ, bọ trĩ, ruồi vàng, xua đuổi côn trùng gây hại hiệu quả",
  },
  {
    icon: "🌱",
    title: "Giải độc & cải tạo đất",
    desc: "Loại bỏ (khóa) kim loại nặng, giải độc đất, hoạt hóa vi sinh vật có lợi",
  },
  {
    icon: "💧",
    title: "Bổ sung dinh dưỡng",
    desc: "Bổ sung vitamin – khoáng chất, thúc đẩy trao đổi chất, giúp lá xanh bóng khỏe",
  },
];

export default function BisoJicaSection1() {
    ...
    >
      ...
      >
        ...
        <div style={{ paddingRight: mobile ? 0 : 20 }}>
          ...
          >
            Ngăn ngừa nấm lá sâu bệnh, thối trái và kim loại nặng
          </h1>
          ...
          >
            ...
            >
              "Diệt nấm tận gốc – Giảm lo, giảm tốn,
              <br />
              tăng mùa bội thu"
            </p>
          </blockquote>
