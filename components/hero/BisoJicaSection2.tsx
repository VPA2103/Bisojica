...
const features = [
    {
      icon: "🌸",
      title: "Phân hóa mầm hoa",
      desc: "Enzyme giúp cây phân hóa mầm hoa, ra bông đậu trái tự nhiên, không cần kích thích hóa học",
    },
    {
      icon: "🌼",
      title: "Hoa rực rỡ – bông to",
      desc: "Giúp hoa màu sắc rực rỡ hơn, tạo bông to lớn, kéo dài tuổi thọ của hoa",
    },
    {
      icon: "🍈",
      title: "Nuôi trái to đều",
      desc: "Bổ sung dinh dưỡng hữu cơ nuôi trái to đều, lớn nhanh, ngọt tự nhiên và an toàn",
    },
    {
      icon: "📈",
      title: "Tăng năng suất",
      desc: "Tăng năng suất, nâng chất lượng nông sản, giúp cây phát triển bền vững",
    },
  ];

export default function BisoJicaSection2() {
    ...
    >
      ...
      >
        ...
        <div style={{ paddingRight: mobile ? 0 : 20 }}>
          ...
          >
            Phấn hóa mầm hoa, nuôi trái ngọt an toàn
          </h1>
          ...
          >
            ...
            >
              "Cây ăn no - trái đầy kho - ví bớt lo"
            </p>
          </blockquote>
        </div>
